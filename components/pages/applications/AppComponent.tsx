...
export const AppComponent = ({ data }: Props) => {
      ...
      <div className="lg:col-span-3">
        ...
        <div className="bg-[#1EBAE51A] px-3 py-11 lg:px-24">
          ...
          <p className="mx-auto mt-4 max-w-5xl text-sm text-svg lg:text-base">
            ...
            coatings. Our range of waterproofing applications includes synthetic
            resins / superior hybrid polymers / acrylic resins and polymer-based
            products alone or in suitable combination. They differ from other
            traditional waterproof coatings due to their excellent flexibility
            and superior UV resistance. Specially formulated structures
            developed by Orhun Kimya make waterproofing application products
            ideal for use on both horizontal and vertical surfaces. The coating
            becomes part of the concrete repair by repairing cracks in the
            underlying surfaces and adhering perfectly to most building
            materials. Our waterproofing application products can be produced in
            different colors according to customer demands. White waterproofing
            application products offer extra benefits with their high sunlight
            reflectivity.
          </p>
        </div>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col gap-2 bg-[#1EBAE51A] p-7">
                ...
                <p className="text-sm text-secGray">
                  Orhun Kimya waterproofing application product range consists
                  of one-piece, high-quality, pollution-free waterproof membrane
                  coatings. Our range of waterproofing applications includes
                  synthetic resins / superior hybrid polymers / acrylic resins
                  and polymer-based products alone or in suitable combination.
                </p>
              </div>
            </div>
            <div className="flex flex-col">
            ...
            content={
              <>
                <p className="text-primary">
                  ...
                  efforts of all our success partners and keenness on continuous
                  improvement and development, To provide various engineering
                  solutions and innovative, advanced, and unique building
                  systems.
                </p>
