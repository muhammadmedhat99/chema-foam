  ...
  return (
    ...
    >
      ...
      <div className="custom-navigation">
        <div
          className="bg-paragraph text-svg cursor-pointer p-4 text-lg"
          onClick={handlePrev}
        >
          <IoIosArrowBack width={20} />
        </div>
        <div
          className="bg-paragraph text-svg cursor-pointer p-4 text-xl"
          onClick={() => {
            setIsPlaying(!isPlaying);
          }}
        >
          {isPlaying ? <IoPauseOutline width={24} /> : <IoIosPlay width={24} />}
        </div>
